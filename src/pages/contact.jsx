...
export const About = () => {
    ...
    return (
        <>
            <div>
                <img src={images.about1} alt="" className='h-[40vh] w-[100%] relative' />
                <h1 className='absolute top-[25vh] left-[20vw] lg:top-[23vh] lg:left-[40vw] text-white font-bold text-7xl'></h1>
            </div> 
            <div className='lg:flex lg:flex-row flex flex-col gap-9 p-11 mr-14 ml-14'>
                <img src={images.about2}className='h-[60vh] lg:w-[28vw] w-[30vw]' alt="" />
